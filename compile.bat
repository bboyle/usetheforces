...
java -jar ..\compiler.jar -js jquery.forces.forms.combined.js -js_output_file jquery.forces.forms.min-google.js
java -jar ..\yuicompressor-2.4.2.jar jquery.forces.forms.combined.js -o jquery.forces.forms.min-yui.js
copy jquery.forces.forms.min-yui.js jquery.forces.forms.min.js

java -jar ..\yuicompressor-2.4.2.jar jquery.forces.lib.validate.js -o jquery.forces.lib.validate.min.js
